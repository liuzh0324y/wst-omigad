...
func router() *mux.Router {
	...
	router.HandleFunc("/api/v1/cloudstorage/sts", getStsAuth).Methods(http.MethodGet)
	router.HandleFunc("/api/v1/cloudstorage/file/{bucket}/{object}", getObjectSize).Methods(http.MethodGet)
